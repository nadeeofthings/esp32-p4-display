...
High-visibility industrial power measurement display application built for the **Waveshare ESP32-P4-WIFI6-Touch-LCD-7B** development board (7-inch 1024x600 MIPI DSI LCD, GT911 Touch, Onboard RS485 transceiver).
...
- **Animated Splash Screen**:
  - Displays `"INDUSTRIAL ELECTRONIC SYSTEMS"` centered in white text across 3 rows using a high-resolution **140px** bold font.
...
- **High-Visibility Measurement UI**:
  ...
  - **Top Row**: Average Voltage in vibrant **Yellow** (`0.0V`).
  - **Bottom Row**: Average Current in vibrant **Cyan** (`0.0A`).
...
- **Touch**: GT911 I2C Capacitive Touch Panel
- **RS485 Interface**:
  - **UART Port**: UART1
  - **TXD Pin**: GPIO 27
  - **RXD Pin**: GPIO 26
...
- **BSP Component**: `esp32_p4_function_ev_board`
...
│   ├── main.c                  # Core application logic & FreeRTOS tasks
...
I (1147) ME231_DISPLAY: LDO VO4 enabled at 3300mV for RS485 transceiver
I (1153) ME231_DISPLAY: RS485 UART initialized (19200 Baud, 8N1, TX Pin 27, RX Pin 26)
I (1422) ME231_DISPLAY: Starting RGB Screen Spill Test...
I (2927) ME231_DISPLAY: Starting Splash Screen Fade In (140px font)...
I (3958) ME231_DISPLAY: Splash Screen visible (holding 5s)...
I (8958) ME231_DISPLAY: Starting Splash Screen Fade Out...
I (9988) ME231_DISPLAY: Main UI initialized: 2 equal centered rows (320px font, +20px vertical offset)
I (9988) ME231_DISPLAY: Startup sequence complete. Starting Modbus Reader task...
```